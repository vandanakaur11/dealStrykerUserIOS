    ...
    <Pressable style={styles.carCard}>
      <View style={styles.containerMain}>
        <View style={styles.containerCar}>
          <Pressable
            onPress={() => {
              navigation.navigate("CarModelScreen");
            }}
          >
            <Image
              source={{
                uri: `https://d2axpdwbeki0bf.cloudfront.net/${item.image}`,
              }}
  ...
  async function carLogs() {
    try {
      ...
      let res = await axios.get(
        `https://www.dealstryker.com/models/${carsSelect}/${brandSelect}`
      );
      console.log(carsSelect);
    ...
    <View style={styles.container}>
      <View style={styles.yearCont}>
        ...
        >
          <Text
            style={
              carsSelect !== 2020 ? styles.yearWrap1 : styles.yearWrap1Select
            }
          >
            2021
          </Text>
        ...
        >
          <Text
            style={
              carsSelect === 2021 ? styles.yearWrap2 : styles.yearWrap2Select
            }
          >
            2020
          </Text>
            ...
            <Pressable key={ind} style={styles.carCard}>
              <View style={styles.containerMain}>
                <View style={styles.containerCar}>
                  <Pressable
                    onPress={() => {
                      navigation.navigate("CarModelScreen", { carIndex: ind });
                    }}
                  >
                    {newData.image === "NA" && (
                      <Text style={styles.noPic}>
                        Picture not available for now
                      </Text>
                    )}
                    {newData.image !== "NA" && (
                      <Image
                        source={{
                          uri: `https://d2axpdwbeki0bf.cloudfront.net/${newData.image}`,
                        }}
                        style={{
                          width: win.width / 1.5,
                          height: win.width / 3,
